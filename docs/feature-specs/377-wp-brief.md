...
**Status:** BUILDING. U1 ✅ SHIPPED (#861, migs 075873+075874 — schema). U2a ✅ SHIPPED (migs 075876+075879 — PD authoring RPCs). U2b ✅ SHIPPED (authoring UI, tablet-first — dedicated `/brief` route + editor). ▶ U3 next (SA/PM read surfaces) — then U4 register+dial+usage signal.

# Progress tracker — archive

Completed units **before Spec 21** (through the sun-readable redesign, spec 20), archived 2026-06-13 to keep the active tracker small for Claude Code. Chronological, oldest first. Active units live in [`progress-tracker.md`](progress-tracker.md).

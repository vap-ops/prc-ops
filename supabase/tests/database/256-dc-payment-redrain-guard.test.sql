...
-- ============================================================================
-- Re-drain guard on post_wage_payment_to_gl — twin of the spec 249 U1c receipt
...
insert into public.workers (id, name, pay_type, employment_type, day_rate, active, created_by) values
  ('aa000001-0000-4000-8000-000000000656', 'Re-drain DC', 'daily', 'permanent', 200.00, true,
...
select is(
  (select count(*)::int from public.journal_entries e
    where e.source_table = 'wage_payments'

-- Spec 270 U2b fix — import_wp_grouping: corrected CREATE OR REPLACE. 072300 shipped
-- an untyped-null coalesce (42804: COALESCE uuid vs text) in the _imp_ids build —
-- the fn died on every valid apply. Same body otherwise; new migration per the

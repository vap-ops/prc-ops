    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex justify-end gap-2">
        <button
          ...
          disabled={!canReject}
          className="bg-danger text-on-danger hover:bg-danger-strong focus-visible:ring-danger disabled:bg-edge disabled:text-ink-muted inline-flex h-11 items-center justify-center rounded-md px-3 text-sm font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed"
        >

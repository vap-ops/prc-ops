...
export const SAMPLE_DAILY_REPORT: DailyReportView = {
  ...
  headcountByType: { company: 0, daily: 8, subcon: 1 },
  lateCount: 1,
  otCount: 2,
  photoCount: 12,
  entries: [
    ...
    },
    {
      ...
      workers: [
        { name: "วีระชาต", type: "daily" },
        { name: "จันทร์", type: "daily" },
        { name: "โสภา", type: "daily" },
        { name: "อรปรีญา", type: "daily" },
        { name: "สมเพศ", type: "daily" },
        { name: "ยุทธชัย", type: "daily" },
        { name: "สุบิน", type: "daily" },
        { name: "วินัย", type: "daily" },
      ],
      exceptions: [
